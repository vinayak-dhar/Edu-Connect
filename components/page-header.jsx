 ...
 * @param {string} props.backLink - URL to navigate back to (default to home)
 * @param {string} props.backLabel - Text for the back link (default to "Back to Home")
 */

export function PageHeader ({
    icon,
    title,
    backLink = "/", // this is the back button 
    backLabel = "Back to Home" // by default - Back to Home
}) {
    return (
